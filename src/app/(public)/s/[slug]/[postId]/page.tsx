...
export default async function PostDetailPage({ params }: PostDetailPageProps) {
  ...
  return (
    <main className="mx-auto grid w-full max-w-[920px] gap-8 px-3 py-8 sm:px-4 sm:py-12">
      ...
      <article
        className="grid gap-5 rounded-lg border border-border bg-panel p-5 text-base leading-7 text-foreground [&_a]:font-bold [&_a]:text-accent-strong [&_a]:underline [&_blockquote]:m-0 [&_blockquote]:border-l-4 [&_blockquote]:border-border [&_blockquote]:pl-4 [&_code]:rounded [&_code]:bg-background [&_code]:px-1 [&_h1]:mb-3 [&_h1]:mt-6 [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:leading-tight [&_h2]:mb-3 [&_h2]:mt-6 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:leading-tight [&_h3]:mb-2 [&_h3]:mt-5 [&_h3]:text-xl [&_h3]:font-bold [&_h3]:leading-tight [&_hr]:w-full [&_hr]:border-border [&_img]:max-w-full [&_img]:rounded-lg [&_li]:my-1 [&_ol]:pl-6 [&_p]:m-0 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:bg-background [&_pre]:p-4 [&_table]:w-full [&_table]:border-collapse [&_td]:border [&_td]:border-border [&_td]:p-2 [&_th]:border [&_th]:border-border [&_th]:p-2 [&_ul]:pl-6"
